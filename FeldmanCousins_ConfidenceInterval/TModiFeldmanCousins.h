...
#ifndef ROOT_TModiFeldmanCousins
#define ROOT_TModiFeldmanCousins
...
class TModiFeldmanCousins : public TObject {
protected:
   ...
   ////////////////////////////////////////////////
   Double_t Prob(Int_t k, Double_t mu, Double_t B, Double_t N);
...
public:
   TModiFeldmanCousins(Double_t newCL=0.9, TString options = "");
   virtual ~TModiFeldmanCousins();
   ...
   ClassDef(TModiFeldmanCousins,1) //calculate the CL upper limit using the Feldman-Cousins method
};
